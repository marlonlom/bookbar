...
import dev.marlonlom.apps.bookbar.categories.BrowseCategoriesContract.ViewModelFactory
...
class ViewModelFactoryTest : TestCase() {
    ...
    fun `Should return a viewmodel instance of required class`() {
        ...
        val createdViewModel =
            viewModelFactory.create(BrowseCategoriesContract.ViewModel::class.java)
