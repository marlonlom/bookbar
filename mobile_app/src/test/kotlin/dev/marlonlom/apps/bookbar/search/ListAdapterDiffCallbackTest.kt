...
class ListAdapterDiffCallbackTest : TestCase() {
    ...
    private val diffCallback = SearchedBooksListAdapter.DiffCallback()

    @Test
    fun `Should return false when comparing the contents of two items`() {
        val oldItem = searchedKotlinBooksApiResponse.books!![0]
        val newItem = searchedKotlinBooksApiResponse.books!![1]
