...
import dev.marlonlom.apps.bookbar.detail.BookDetailsContract.ViewModelFactory
...
class ViewModelFactoryTest : TestCase() {
    ...
    fun `Should return a viewmodel instance of required class`() {
        ...
        val createdViewModel = viewModelFactory.create(BookDetailsContract.ViewModel::class.java)
