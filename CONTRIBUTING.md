...
> tracker, or elsewhere in public. Instead sensitive bugs must be sent by email to <malm.gm@gmail.com>.
...
- **Explain why this enhancement would be useful** to most Glucoreo users. You may also want to point out the other
